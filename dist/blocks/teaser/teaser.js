export default function decorate(block) {
  ...
  let captionDiv = block.children[0].children[1]; // check if left or right
  ...
  imageDiv.setAttribute('class', 'teaser-image'); // grap the caption elements

  const title = captionDiv.querySelector('h2');
  const text = captionDiv.querySelector('p:not(.button-container)'); // ... and place text inside additional div
